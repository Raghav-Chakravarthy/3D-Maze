...
public class Header{
    public static void drawHeader(BufferedImage image, int currentMoves, Coordinate coordinate, int direction){
        ...
        graphics.drawString("Level: "+(coordinate.getLevel()+1)+" | Row: "+(coordinate.getRow()+1)+" | Column: "+(coordinate.getColumn()+1),10,22);
        ...
        graphics.drawString("Direction: "+ Direction.toString(direction), 570,22);
    }
}