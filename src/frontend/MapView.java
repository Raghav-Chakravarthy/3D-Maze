    ...
    public void paintComponent(Graphics g){
        ...
        if(backend.getDifficulty().equals("easy")){
            for(int i = 0; i<4; i++){
                for(int j = 0; j<4; j++){
                    chamber = level[i][j];
                    if(backend.getChamber().getCoordinate.getRow() == i && backend.getChamber().getCoordinate.getColumn() == j){
                    ...
                    if(chamber.getVisited() == false){
                        ...
                        for(int a = 0; a<6; a++){
                            if(chamber.getAdjacentChamber[a] == 0){
                            ...
                            }else if(chamber.getAdjacentChamber[a] == 1){
                                g.drawLine(fourValues[i], fourValues[j], fourValues[i]-(doorLength4*2), fourValues[j]);
                                g.drawLine(fourValues[i]-doorLength4, fourValues[j], fourValues[i+1], fourValues[j]);
                            }else if(chamber.getAdjacentChamber[a] == 2){
                            ...
                            }else if(chamber.getAdjacentChamber[a] == 3){
                                g.drawLine(fourValues[i], fourValues[j], fourValues[i], fourValues[j]-(doorLength4*2));
                                g.drawLine(fourValues[i], fourValues[j]-doorLength4, fourValues[i], fourValues[j+1]);
                            }else if(chamber.getAdjacentChamber[a] == 4){
                                if(chamber.getAdjacentChamber[a] == 5){
                            ...
                            }else if(chamber.getAdjacentChamber[a] == 5){
        ...
        }else(backend.getDifficulty().equals("hard")){
            for(int i = 0; i<5; i++){
                for(int j = 0; j<5; j++){
                    chamber = level[i][j];
                    if(backend.getChamber().getCoordinate.getRow() == i && backend.getChamber().getCoordinate.getColumn() == j){
